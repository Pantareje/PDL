...
\begin{center}
    \begin{tcolorbox}[title=Símbolos no terminales, width=0.4\textwidth]
        $d$ := 0...9
        
        $l$ := a..z, A...Z
        
        $c_1$ := cualquier carácter menos \textbackslash
        
        $cesc$ := carácter escapable (' o \textbackslash )
        
        $c_2$ := cualquier carácter menos *
        
        $c_3$ := cualquier carácter menos * y /
    \end{tcolorbox}
\end{center}
